...
RUN rm -rf $HOME/wildfly/standalone/deployments/apiman-es.war \
...
RUN curl -o ${JBOSS_HOME}/standalone/deployments/postgresql.jar https://repo1.maven.org/maven2/org/postgresql/postgresql/9.4-1206-jdbc41/postgresql-9.4-1206-jdbc41.jar
RUN curl -o ${JBOSS_HOME}/standalone/deployments/mysql.jar https://repo1.maven.org/maven2/mysql/mysql-connector-java/5.1.33/mysql-connector-java-5.1.33.jar
